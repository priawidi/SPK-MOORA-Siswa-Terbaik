...
<body>
    ...
    <div class="row p-3">
        ...
        <div class="col-md-12 head">
            <div class="float-end">
                <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importForm');"><i class="plus"></i> Import Data Kelas 8</a>
            </div>
        </div>

        <button type="button" class="btn btn-success btn-lg" style="display: none" id="importForm">

            <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm1');"><i class="plus"></i> Import Data Kelas 8</a>
