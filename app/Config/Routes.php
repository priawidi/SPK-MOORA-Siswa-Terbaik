...
$routes->match(['get', 'post'], '/editkriteria/(:num)', 'KriteriaController::edit_kriteria/$1', ['filter' => 'authGuard']);
...
$routes->match(['get', 'post'], '/editnilaisiswa/(:num)', 'SiswaController::edit_nilai_siswa/$1', ['filter' => 'authGuard']);
$routes->get('/detailnilaisiswa/(:num)', 'SiswaController::detail_nilai_siswa/$1', ['filter' => 'authGuard']);
//HASIL HITUNGAN
$routes->get('/hasilhitung', 'MooraController::index', ['filter' => 'authGuard']);
//IMPORT EXCEL
$routes->get('/importxls', 'DataController::importxls', ['filter' => 'authGuard']);
$routes->post('/savexls/(:num)', 'DataController::save_excel/$1', ['filter' => 'authGuard']);
